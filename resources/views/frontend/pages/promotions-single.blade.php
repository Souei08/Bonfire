...
@section('seo')
<title>Promotions | Bonfire Charcoal: Ignite Culinary Excellence with Premium Briquets for Grilling Perfection</title>
...
<div class="banner">
    <div class="row justify-content-center">
        <div class="col-lg-12 text-center">
            <h1 class="text-white" style="font-size: 75px;">PROMOTIONS</h1>
        </div>
        <div class="col-lg-12">
            <div class="d-flex align-items-center justify-content-center">
                ...
                <h3 class="yellow mb-0">Promotions</h3>
            </div>
        </div>
    </div>
</div>
...
<div class="container">
    <img src="{{ asset('images/img-promo.png') }}" class="d-block align-middle img-fluid w-100" alt="...">
    <br>
    ...
    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqu. Aenean euismod elementum nisi quis eleifend quam.
        Facilisi cras fermentum odio feugiat pretium nibh inpsum. Id consectetur purus ut faucibus pulvinar elementum integer. Gravida neque convallis a cras semper.
        Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqu. Aenean euismod elementum nisi quis eleifend quam.
    ...
    <div class="row justify-content-center align-items-center p-3">
        <a href="" class="btn btn-primary-3 fs-4 px-5 w-auto d-flex align-items-center">
            <span class="span-text">AVAIL PROMO NOW</span>
        </a>
    </div>
</div>
