                        ...
                        <div class="row bg-white rounded-2">
                            ...
                            <div class="col-lg-7">
                                <div class="p-5 bg-white rounded">
                                    ...
                                    <form action="{{url('user/updateAccount')}}" method="POST">@csrf @method('PUT')
                                    <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-2">
                                                ...
                                                <input type="text" name="city" class="form-control rounded-0" id="city" style="border: none; border-bottom: solid #f6b024 2px; height: 40px;" value="{{$profiles->city}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-2">
                                                ...
                                                <input type="email" name="email" class="form-control rounded-0 text-muted" id="email" style="border: none; border-bottom: solid #f6b024 2px; height: 40px;" value="{{$profiles->email}}" readonly>
                                            </div>
                                        </div>
