...
<div class="p-3">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{url('admin/products')}}" method="POST" enctype="multipart/form-data">@csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="prodName" id="exampleFormControlInput1" placeholder="">
                @error('prodName')
                <span class="text-danger">
                    {{ $message }}
                </span>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="varation" id="exampleFormControlInput1" placeholder="">
                @error('varation')
                <span class="text-danger">
                    {{ $message }}
                </span>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="weight" id="exampleFormControlInput1" placeholder="">
                @error('weight')
                <span class="text-danger">
                    {{ $message }}
                </span>
            ...
            <div class="row">
                <div class="col">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="height" id="exampleFormControlInput1" placeholder="">
                        @error('height')
                        <span class="text-danger">
                            {{ $message }}
                        </span>
                ...
                <div class="col">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="width" id="exampleFormControlInput1" placeholder="">
                        @error('width')
                        <span class="text-danger">
                            {{ $message }}
                        </span>
                ...
                <div class="col">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="length" id="exampleFormControlInput1" placeholder="">
                        @error('lenght')
                        <span class="text-danger">
                            {{ $message }}
                        </span>
